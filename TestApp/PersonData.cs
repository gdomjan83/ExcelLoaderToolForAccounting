...
namespace TestApp {
    public class PersonData {
        ...
        public PersonData(String name, String month, String credit, String debit, String salary, String tax, int note , String projectName, String workerType, String miss, String taxId) {
            Name = name;
            Month = month;
